...
public class FactMonthlySales {
  ...
  @Column(name = "unique_sellers")
    private Integer uniqueSellers; // Số lượng người bán
    ...
    private Integer cancelledOrders; // Số lượng đơn hàng bị hủy
    ...
    private Double listingToSaleRate;

    @Column(name = "avg_listing_duration_days")// Phần trăm sản phẩm đã đăng bán
