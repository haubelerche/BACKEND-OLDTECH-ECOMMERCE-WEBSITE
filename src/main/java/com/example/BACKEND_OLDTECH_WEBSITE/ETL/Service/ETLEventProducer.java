...
public class ETLEventProducer {
    ...
    /**
     * Send ETL completion event with all result details
     */
    public void sendETLCompletionEvent(String processDate, String status, long duration, Map<String, Object> summary) {
        publishETLCompletionEvent(processDate, status, duration, summary);
    }    // ===============================
